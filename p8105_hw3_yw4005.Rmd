...
accel_data <- read_csv("./Data/accel_data.csv") %>%
  ...
  mutate(is_weekday = ifelse(day %in% c("Saturday", "Sunday"),
                             FALSE,
                             TRUE))
```
...
It seems for every day in a week, there is a specific period of time that has low activity. At other times of the day, there is a day-effect on the time that the participant did activity. There are dots that are on top of one another, forming a straight line. These dots are all in the same color, indicating the same day of the week. In general, the participant did more activity in the morning (assuming min 1 is midnight) on Fridays and Saturdays, in later of the day (assuming min 1 is midnight) on Thursdays and Tuesdays.
